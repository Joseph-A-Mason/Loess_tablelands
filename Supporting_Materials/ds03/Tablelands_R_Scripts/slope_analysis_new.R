...
setwd("C:/Users/mason/Dropbox/aeolian_landscapes/eguModels/sensitivity/K0012D01/flat3dep")
...
#for ESRI ascii dem
dem2 = rast('148.0elevation_Brady.txt')
demname = "148.0elevation_Brady"
crs(dem2)<-'EPSG:26914'
#make a temporary tiff

setwd("C:/Users/mason/Dropbox/aeolian_landscapes/GIS_working/10m_DEMs")
...
demname<-"180.0elevation_Bignell"
...
plot(hshd2, 
     ...
     legend=FALSE, 
     mar=c(3,3,3,7),
     pax=list(cex.axis=1.5, xat=c(1000, 3000, 5000), yat=c(1000, 3000, 5000)))
